...
import WlkFileUpload from "../components/FileUpload/WlkFileUpload.vue";

const model = ref<string>('');
const fileModel = ref<FileList | null>(null);
</script>

<template>
	<main id="main" aria-labelledby="main-title" role="main">
        <h1 id="main-title">Local App</h1>
		<WlkFileUpload label="File upload" v-model="fileModel" class="compact"></WlkFileUpload>
